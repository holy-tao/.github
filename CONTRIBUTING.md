...
Contributions are welcome on all of my public repos. You can contribute in a variety of ways, including (but not limited to):
...
## Environment Setup
This is my default CONTRIBUTING.md file. If you're reading it, you can assume that there's no special setup needed to get started with development on this project. If that assumption turns out to be wrong, 
please open an issue - I may have forgotten to update the file.
